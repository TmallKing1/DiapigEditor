...
import top.pigest.queuemanagerdemo.liveroom.ui.WebStartLivePage;
...
public class MainPage extends BorderPane implements NamedPage {
    ...
    public MainPage(MainScene parent) {
        ...
        functions.add(parent.createMainFunctionButton("#ae5220", "#cf9d81", "快捷开播", "fas-video", WebStartLivePage::new), 0, 0);
        functions.add(parent.createMainFunctionButton("#357c56", "#73be95", "弹幕服务", "fas-hamburger", DanmakuServicePage::new), 1, 0);
