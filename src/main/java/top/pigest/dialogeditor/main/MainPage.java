...
import top.pigest.dialogeditor.comment.ui.CommentGetterPage;
...
public class MainPage extends BorderPane implements NamedPage {
    ...
    public MainPage(MainScene parent) {
        ...
        functions.add(parent.createMainFunctionButton("#357c56", "#73be95", "评论抓取", "fas-comment-dots", CommentGetterPage::new), 1, 0);
